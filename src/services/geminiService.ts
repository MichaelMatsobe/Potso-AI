/**
 * Client AI helper — always prefers backend public endpoint (Ollama / Freebuff / Gemini).
 * No browser-side API keys required for the default open-source path.
 */
    ...
    return {
      content:
        error instanceof Error
          ? `I could not reach the AI backend (${error.message}). Ensure the API is running on :8080 and Ollama is available (ollama serve).`
